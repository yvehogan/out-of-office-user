          ...
          <section className="w-full h-auto py-10 px-6 md:px-12 xl:pt-[24px] 2xl:py-[60px] xl:px-6 bg-white flex flex-col gap-[6px] xl:border-none xl:h-[calc(100vh-120px)] 2xl:h-full xl:shrink-0 xl:inline-flex xl:align-top xl:whitespace-normal xl:overflow-visible xl:w-max xl:justify-start xl:pr-[60px]" id="shop">
            <div className="pl-0 mb-[30px] xl:pl-[24px] 2xl:!pl-[100px] xl:mb-[16px] 2xl:mb-[40px]">
              ...
              <div className="flex flex-col items-start gap-4 w-full md:flex-row md:justify-start md:gap-6 md:items-center xl:items-center xl:gap-8 2xl:pb-[18px]">
                ...
                <Button render={<Link href="/shop" />} className="group !inline-flex items-center justify-center w-full md:w-auto md:px-10 px-7 py-6 rounded-[47px] bg-brand-green text-brand-purple2 font-ui text-base font-medium no-underline border-none cursor-pointer relative overflow-hidden transition-all duration-300 shadow-[0_4px_14px_rgba(0,204,141,0.2)] hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(0,204,141,0.4)] xl:w-auto xl:py-2 xl:px-6 2xl:!px-9 2xl:!py-5 2xl:!text-lg">
                  <span className="absolute inset-0 bg-brand-purple translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out rounded-[47px]"></span>
              ...
              <div className="flex flex-col w-full md:w-1/2 xl:w-[330px] 2xl:!w-[520px]">
                ...
                <div className="mt-8 flex flex-col items-start gap-[10px] xl:mt-8 xl:gap-[6px] 2xl:!gap-[16px]">
                  ...
                  <div className="flex gap-[10px] 2xl:!gap-[16px]">
                    ...
                    <a href="https://x.com/thesolomonayo" target="_blank" rel="noopener noreferrer" className="group/social w-[42px] h-[36px] rounded-[18px] 2xl:!w-[56px] 2xl:!h-[48px] 2xl:!rounded-[24px] border border-brand-purple bg-transparent text-brand-purple flex items-center justify-center cursor-pointer no-underline transition-all duration-[0.3s] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[2px] hover:bg-brand-purple hover:text-white hover:border-brand-purple [&>svg]:w-[18px] [&>svg]:h-[18px] 2xl:![&>svg]:w-[24px] 2xl:![&>svg]:h-[24px] hover:[&_.ig-inner]:fill-brand-purple" aria-label="X">
                    ...
                    <a href="https://www.solomonayodele.com/" target="_blank" rel="noopener noreferrer" className="group/social w-[42px] h-[36px] rounded-[18px] 2xl:!w-[56px] 2xl:!h-[48px] 2xl:!rounded-[24px] border border-brand-purple bg-transparent text-brand-purple flex items-center justify-center cursor-pointer no-underline transition-all duration-[0.3s] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[2px] hover:bg-brand-purple hover:text-white hover:border-brand-purple [&>svg]:w-[18px] [&>svg]:h-[18px] 2xl:![&>svg]:w-[24px] 2xl:![&>svg]:h-[24px] hover:[&_.ig-inner]:fill-brand-purple" aria-label="Website">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
