          ...
          >
            ...
            >
              ...
              >
                <p
                  id="insight-text"
                  className="font-unageo lg:max-w-80 text-lg md:text-[17px] w-full font-light leading-normal text-brand-purple2 mb-7.5 xl:mb-7 xl:text-[24px] 2xl:mb-12 2xl:text-[24px]! whitespace-normal xl:w-full 2xl:w-full"
                >
